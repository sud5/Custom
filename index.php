...
<head>
    <title>UpTech — IT Solutions and Services Website Template</title>
                ...
                <div class="container">
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-7">
                            ...
                            <h1 class="no-bottom">We crafting digital solutions with cutting-edge technology.</h1>
                        </div>
                            ...
                            <div class="padding60 sm-padding40 rounded-30 bg-color h-100 text-light">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <h2 class="mb20 wow fadeInUp" data-wow-delay=".2s">"Their IT solutions have transformed the way we operate and have greatly enhanced our customer experience."</h2>
                                        <h6 class="mb20 wow fadeInUp">Emma Roberts - Customer</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h2 class="wow fadeInUp" data-wow-delay=".2s">What can UpTech do for you?</h2>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInRight" data-wow-delay="0s">
                            <div class="padding30 bg-grey h-100 rounded-20">
                                ...
                                <hr class="s2">
                                <p class="mb0">Provide management and maintenance of IT infrastructure, including servers, networks, and software.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6 wow fadeInRight" data-wow-delay=".6s">
                            <div class="padding30 bg-grey h-100 rounded-20">
                                ...
                                <hr class="s2">
                                <p class="mb0">Designing, implementing, and managing databases, including SQL and NoSQL databases.</p>
                            </div>
                        </div>
                    </div>
                </div>
